...
void Cube :: f(int x)
{
    ...
    case 12:
        ...
        break;
    case 13:
        cout<<"  rotate the cube to the left\n";
        //cube.rotate_to_left();
        break;
    case 14:
        cout<<"  rotate the cube to the right\n";
